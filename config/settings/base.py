...
MIGRATION_MODULES = {
    'sites': 'developer_kit.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'developer_kit.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'developer_kit.users.adapters.SocialAccountAdapter'
